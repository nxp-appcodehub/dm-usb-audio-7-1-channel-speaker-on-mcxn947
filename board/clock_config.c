...
void BOARD_BootClockPLL150M(void)
{
     ...
     const pll_setup_t pll1Setup = 
    {
        ...
        .pllpdiv = SCG_SPLLPDIV_PDIV(12U),
        .pllsscg = {(SCG_SPLLSSCG0_SS_MDIV_LSB(206158430U)),((SCG0->SPLLSSCG1 & ~SCG_SPLLSSCG1_SS_PD_MASK) | SCG_SPLLSSCG1_SS_MDIV_MSB(0U) | (uint32_t)(kSS_MF_512) | (uint32_t)(kSS_MR_K0) | (uint32_t)(kSS_MC_NOC) | SCG_SPLLSSCG1_SEL_SS_MDIV_MASK)},
        .pllRate = 12287999U
    };
    ...
    //CLOCK_AttachClk(kPLL1_CLK0_to_CLKOUT);                 /*!< Switch CLKOUT to PLL1 */
    //CLOCK_SetClkDiv(kCLOCK_DivClkOut, 4U);           /*!< Set CLKOUTDIV divider to value 4 */
